...
vue__WEBPACK_IMPORTED_MODULE_0__.default.component("modal", {
  template: "<div class=\"w-full bg-red-400 min-h-screen flex items-center justify-center text-4xl text-white\"><span class=\"fixed cursor-pointer\" @click=\"$emit('closed')\" style=\"top: 20px; right: 20px;\">X</span>Hello, modal!</div>"
});
