...
/* harmony import */ var _components_Hello_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/Hello.vue */ "./resources/js/components/Hello.vue");
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "w-full min-h-screen flex justify-center items-center" },
    [
      _c(
        "div",
        {
          staticClass:
            "max-w-5xl mx-auto bg-white rounded-md shadow-md p-8 text-gray-500 text-center"
        },
        [
          _c("h1", { staticClass: "text-2xl font-semibold mb-6" }, [
            _vm._v("Welcome to your new Laravel application")
          ]),
          _vm._v(" "),
          _vm.auth && _vm.username !== ""
            ? _c("div", [
                _c("p", [_vm._v("Welcome back, " + _vm._s(_vm.username))]),
                _vm._v(" "),
                _c(
                  "form",
                  {
                  ...
                  [
                    ...
                    _c("input", {
                      staticClass:
                        "bg-blue-500 py-1 px-2 text-white cursor-pointer border border-blue-500 hover:text-blue-500 hover:bg-white",
